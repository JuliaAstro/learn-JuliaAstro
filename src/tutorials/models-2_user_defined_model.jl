...
# ╔═╡ d034daed-94fe-4fb6-a563-5e6aaee520e6
using Printf

# ╔═╡ 3991b8c2-1769-43ed-bf1d-76faf223917d
using Downloads: download

# ╔═╡ 716dfcc5-d5a8-498d-b699-057d39ce694a
using FITSFiles
...
# ╔═╡ 94b2a807-6785-488a-aae2-7922bed3f338
sdss_download_url(plate, fiberID, mjd) = @sprintf("https://data.sdss.org/sas/dr17/sdss/spectro/redux/26/spectra/%d/spec-%d-%d-%4d.fits", plate, plate, mjd, fiberID);
...
# ╔═╡ 975fd462-e554-4652-961d-625c7b50fd2c


# ╔═╡ 69b36539-d9df-4a15-aacb-4130cc67c748
...
flux = spectrum[:COADD].data["flux"]

# ╔═╡ 34a8d7cb-64b6-4813-ae83-3acd55d40f68
lam = exp10.(spectrum[:COADD].data["loglam"])
...
units_flux = spectrum[1].cards["BUNIT"]
...
units_wavelength_full = spectrum[1].cards["WAT1_001"]
...
manifest_format = "2.0"
project_hash = "b17f4f1d92bef8c5395c7c9b71d9aac581d1bede"
