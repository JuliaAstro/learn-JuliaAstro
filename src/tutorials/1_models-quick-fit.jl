...
# ╔═╡ 680c0208-d23a-11f0-9ad4-010f93a8c6ed
...
See [this JuliaAstro tutorial](https://learn.juliaastro.org/tutorials/fits-images/#Plotting-with-Makie.jl-+-AoG.jl)
"""
...
md"""
Note that while convenient for quick visualizations, this only computes an unweighted linear model for us out-of-the box. For more control, we will show how to compute various different models weighted by the uncertainty in our data.
"""
...
X = [df.log_P ones(length(df.log_P))]
...
git-tree-sha1 = "25bd9efc6c1b089c538a3272f3f3dd5c2a91cd2e"
...
git-tree-sha1 = "23640dcf6d8290b3e950ffdfd7069d62f6f828c4"
